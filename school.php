	...
	<div class="row">
		<div class="col">
			<div class="form-group padding">
    			<label for="name"><strong>Student first name:</strong></label>
   				 <input type="text" name="studentfirstname" value="<?php echo $studentfirstname;?>" class="form-control border-gradient"  placeholder="Enter first name">
  				<span class="error"> <?php echo $studentfirstnameErr;?></span>
  				<br><br>
 			 </div>
 			 <div class="form-group padding">
    			<label for="name"><strong>Student last name:</strong></label>
   				 <input type="text" name="studentlastname" value="<?php echo $studentlastname;?>" class="form-control border-gradient"  placeholder="Enter last name">
  				<span class="error"> <?php echo $studentlastnameErr;?></span>
  				<br><br>
 			 </div>
 			 <div class="form-group padding">
    			<label for="email"><strong>Student email Address:</strong></label>
   				<input type="text" name="studentemail" value="<?php echo $studentemail;?>" class="form-control border-gradient"  placeholder="Enter email">
 			 ...
 			 <div class="form-group padding">
    			<label for="integer"><strong>Admission number:</strong></label>
   				 <input type="text" name="admissionnumber" value="<?php echo $admissionnumber;?>" class="form-control border-gradient" placeholder="Enter admission number" id="integer" >
